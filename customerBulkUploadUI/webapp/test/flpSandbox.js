		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#customerBulkUploadUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerBulkUploadUI-display": {
								"semanticObject": "customerBulkUploadUI",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerBulkUploadUI",
									"url": sap.ui.require.toUrl("customerBulkUploadUI")
								}
							}
						}
					}

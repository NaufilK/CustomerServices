sap.ui.define([
    ...
    return Controller.extend("customerChangeUI.sections.SalesArea.AccountingController", {
        ...
        onAfterRendering: function (oEvent) {
            ...
            if (!this.InvcDates) {
                this.InvcDates = new sap.ui.xmlfragment("customerChangeUI.fragments.InvcDates", this);
                this.InvcDates.setModel(this.getOwnerComponent().getModel());
                this.getView().addDependent(this.InvcDates);
            }

            if (!this.InvcLists) {
                this.InvcLists = new sap.ui.xmlfragment("customerChangeUI.fragments.InvcList", this);
            ...
            if (!this.TaxCategory) {
                this.TaxCategory = new sap.ui.xmlfragment("customerChangeUI.fragments.TaxCategory", this);
                this.getView().addDependent(this.TaxCategory);
                this.TaxCategory.setModel(this.getOwnerComponent().getModel("S4D"));
            }
            if (!this.TaxClassfn) {
                this.TaxClassfn = new sap.ui.xmlfragment("customerChangeUI.fragments.TaxClassfn", this);
            ...
            if (!this.customerGrp1) {
                this.customerGrp1 = new sap.ui.xmlfragment("customerChangeUI.fragments.custGrp1", this);
            ...
            if (!this.customerGrp2) {
                this.customerGrp2 = new sap.ui.xmlfragment("customerChangeUI.fragments.custGrp2", this);
            ...
            if (!this.customerGrp3) {
                this.customerGrp3 = new sap.ui.xmlfragment("customerChangeUI.fragments.custGrp3", this);
            ...
            if (!this.customerGrp4) {
                this.customerGrp4 = new sap.ui.xmlfragment("customerChangeUI.fragments.custGrp4", this);
            ...
            if (!this.customerGrp5) {
                this.customerGrp5 = new sap.ui.xmlfragment("customerChangeUI.fragments.custGrp5", this);
            ...
            if (!this.Incoterms) {
                this.Incoterms = new sap.ui.xmlfragment("customerChangeUI.fragments.Incoterms", this);
            ...
            if (!this.blockReason) {
                this.blockReason = new sap.ui.xmlfragment("customerChangeUI.fragments.BlockedReason", this);
            ...
            if (!this.furtherInfo) {
                this.furtherInfo = new sap.ui.xmlfragment("customerChangeUI.fragments.creditSegment", this);
                this.getView().addDependent(this.furtherInfo);
                this.furtherInfo.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.infoCat) {
                this.infoCat = new sap.ui.xmlfragment("customerChangeUI.fragments.InfoCat", this);
                this.getView().addDependent(this.infoCat);
                this.infoCat.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.indusType) {
                this.indusType = new sap.ui.xmlfragment("customerChangeUI.fragments.IndustryType", this);
        ...
        handleCreate: function (evt) {
            ...
            var salesPanel = new sap.ui.xmlfragment("frag" + count, "customerChangeUI.fragments.salesPanel", this);

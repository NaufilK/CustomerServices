sap.ui.define([
	...
	return Controller.extend("customerChangeUI.sections.ERPCustomers.PaymentDataController", {
        /**
         * @override
         */
        onInit: function() {
            ...
            if (!this.KnwnNegtdLv) {
                this.KnwnNegtdLv = new sap.ui.xmlfragment("customerChangeUI.fragments.knowNegotiatedLv", this);
                this.getView().addDependent(this.KnwnNegtdLv);
            }
            if (!this.ARPledgeIndc) {
                this.ARPledgeIndc = new sap.ui.xmlfragment("customerChangeUI.fragments.ARPledgingIndc", this);

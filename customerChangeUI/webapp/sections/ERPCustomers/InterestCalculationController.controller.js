sap.ui.define([
	...
	return Controller.extend("customerChangeUI.sections.ERPCustomers.InterestCalculationController", {
        onInit: function() {
            // Controller.prototype.onInit.apply(this, arguments);
            if (!this.InterestIndicator) {
                this.InterestIndicator = new sap.ui.xmlfragment("customerChangeUI.fragments.InterestIndicator", this);

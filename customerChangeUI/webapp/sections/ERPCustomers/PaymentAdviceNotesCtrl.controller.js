sap.ui.define([
	...
	return Controller.extend("customerChangeUI.sections.ERPCustomers.PaymentAdviceNotesCtrl", {
        onInit: function() {
			if (!this.ReasonCodeConversion) {
                this.ReasonCodeConversion = new sap.ui.xmlfragment("customerChangeUI.fragments.ReasonCodeConversion", this);
                this.getView().addDependent(this.ReasonCodeConversion);
            }
			if (!this.SelectionRule) {
                this.SelectionRule = new sap.ui.xmlfragment("customerChangeUI.fragments.SelectionRule", this);

...
'sap/ui/model/FilterOperator'], function (Controller, Filter, FilterOperator) {
  ...
  return Controller.extend(
    "customerChangeUI.sections.CustomerBasicDetails.BusinessDetailsController",
    {
      /**
       * @override
       */
      onInit: function () {
        if (!this.ChannelGrp) {
          this.ChannelGrp = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.ChannelGrp",
            this
          );
        ...
        if (!this.subChannel) {
          this.subChannel = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.SubChannel",
            this
          );
        ...
        if (!this.channel) {
          this.channel = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.Channel",
            this
          );
        ...
        if (!this.lineOfBusinessType) {
          this.lineOfBusinessType = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.LneOfBusinessType",
            this
          );
        ...
        if (!this.customerType) {
          this.customerType = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.CustType",
            this
          );
        ...
        if (!this.customerInternalRating) {
          this.customerInternalRating = new sap.ui.xmlfragment(
            "customerChangeUI.fragments.CustInterRating",
            this
          );

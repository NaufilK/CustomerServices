sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("customerChangeUI.sections.CustomerBasicDetails.SiteDetailsController", {
            /**
             * @override
             */
            onInit: function() {
                ...
                if (!this.legalName) {
                    this.legalName = new sap.ui.xmlfragment("customerChangeUI.fragments.LegalName", this);

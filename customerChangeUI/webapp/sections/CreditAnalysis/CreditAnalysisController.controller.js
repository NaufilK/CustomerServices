sap.ui.define([
	...
	return Controller.extend("customerChangeUI.sections.CreditAnalysis.CreditAnalysisController", {
        /**
         * @override
         */
        onInit: function() {
            if (!this.CountryRating) {
                this.CountryRating = new sap.ui.xmlfragment("customerChangeUI.fragments.CountryRating", this);

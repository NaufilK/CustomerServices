sap.ui.define([], function () {
    ...
    return {
        ...
        getTotalAmount: function (amt1, amt2, amt3, amt4, amt5, amt6, amt7) {
            ...
            if(this.getView().getModel("Customers").getProperty("/zcredit_limit_type") === 'Secured Credit Limit' || this.getView().getModel("Customers").getProperty("/zcredit_limit_type") === 'Both'){
                var totalCredit = 0;
        ...
        getTotalUnsecuredAmount:function (amt1, amt2, amt3, amt4, amt5, amt6) {
            if(this.getView().getModel("Customers").getProperty("/zcredit_limit_type") === 'UnSecured Credit Limit' || this.getView().getModel("Customers").getProperty("/zcredit_limit_type") === 'Both'){

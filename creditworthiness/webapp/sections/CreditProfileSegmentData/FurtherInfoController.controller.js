sap.ui.define(
  ...
  function (Controller, formatter, MessageBox) {
    ...
    return Controller.extend(
      "customerReview.creditworthiness.sections.CreditProfileSegmentData.FurtherInfoController",
      {
        formatter: formatter,
        /**
         * @override
        ...
        onInit: function () {
          if (!this.furtherInfo) {
            this.furtherInfo = new sap.ui.xmlfragment(
              "customerReview.creditworthiness.fragments.creditSegment",
              this
            );
          ...
          if (!this.infoCat) {
            this.infoCat = new sap.ui.xmlfragment(
              "customerReview.creditworthiness.fragments.InfoCat",
              this
            );
          ...
          if (!this.indusType) {
            this.indusType = new sap.ui.xmlfragment(
              "customerReview.creditworthiness.fragments.IndustryType",
              this
            );

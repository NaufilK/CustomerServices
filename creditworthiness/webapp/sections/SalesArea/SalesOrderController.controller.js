sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("customerReview.creditworthiness.sections.SalesArea.SalesOrderController", {
            /**
             * @override
             */
            onInit: function() {
                ...
                if (!this.unitOfMsrGrp) {
                    this.unitOfMsrGrp = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.UnitOfMeasureGrp", this);
                ...
                if (!this.exchngRateType) {
                    this.exchngRateType = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ExchangeRateType", this);
                ...
                if (!this.PPCustProcedure) {
                    this.PPCustProcedure = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.PPCustrProcedure", this);

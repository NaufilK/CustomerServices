sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.SalesArea.AccountingController", {
		onInit: function() {
            //debugger
            if (!this.salesData) {
                this.salesData = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.SalesFields", this);
                this.getView().addDependent(this.salesData);
            }
            if (!this.salesOrganization) {
                this.salesOrganization = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.SalesOrg", this);
                this.getView().addDependent(this.salesOrganization);
                this.salesOrganization.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.distribution) {
                this.distribution = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.Distribution", this);
                this.getView().addDependent(this.distribution);
                this.distribution.setModel(this.getOwnerComponent().getModel("DistChannelModel"));
            }
            if (!this.division) {
                this.division = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.DivisionSet", this);
                this.getView().addDependent(this.division);
                this.division.setModel(this.getOwnerComponent().getModel("DivModel"));
            }

            if (!this.InvcDates) {
                this.InvcDates = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.InvcDates", this);
                this.InvcDates.setModel(this.getOwnerComponent().getModel());
                this.getView().addDependent(this.InvcDates);
            }

            if (!this.InvcLists) {
                this.InvcLists = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.InvcList", this);
                this.InvcLists.setModel(this.getOwnerComponent().getModel());
                this.getView().addDependent(this.InvcLists);
            }

            if (!this.customerGrp) {
                this.customerGrp = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.CustGroup", this);
                this.getView().addDependent(this.customerGrp);
                this.customerGrp.setModel(this.getOwnerComponent().getModel("S4D"));
            }
            if(!this.TaxCategory){
                this.TaxCategory = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.TaxCategory", this);
                this.getView().addDependent(this.TaxCategory);
                this.TaxCategory.setModel(this.getOwnerComponent().getModel("S4D"));
            }
            if(!this.TaxClassfn){
                this.TaxClassfn = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.TaxClassfn", this);
            ...
            if (!this.customerGrp1) {
                this.customerGrp1 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.custGrp1", this);
            ...
            if (!this.customerGrp2) {
                this.customerGrp2 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.custGrp2", this);
            ...
            if (!this.customerGrp3) {
                this.customerGrp3 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.custGrp3", this);
            ...
            if (!this.customerGrp4) {
                this.customerGrp4 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.custGrp4", this);
            ...
            if (!this.customerGrp5) {
                this.customerGrp5 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.custGrp5", this);
                this.getView().addDependent(this.customerGrp5);
                this.customerGrp5.setModel(this.getOwnerComponent().getModel("S4D"));
            }
            if (!this.DelvryPlant) {
                this.DelvryPlant = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.DeliveryPlant", this);
            ...
            //     this.DelvryPriorty = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.delvryPriorty", this);
            //     this.getView().addDependent(this.DelvryPriorty);
            //     this.DelvryPriorty.setModel(this.getOwnerComponent().getModel("S4D"));
            // }
            if (!this.CCA) {
                this.CCA = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.CreditControl", this);
                this.getView().addDependent(this.CCA);
                this.CCA.setModel(this.getOwnerComponent().getModel());
            }

            if (!this.Incoterms) {
                this.Incoterms = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.Incoterms", this);
                this.getView().addDependent(this.Incoterms);
                this.Incoterms.setModel(this.getOwnerComponent().getModel());
            }

            if (!this.PriceGroup) {
                this.PriceGroup = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.priceGroup", this);
                this.getView().addDependent(this.PriceGroup);
                this.PriceGroup.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.PPDetermination) {
                this.PPDetermination = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.PpDetermination", this);
                this.getView().addDependent(this.PPDetermination);
                this.PPDetermination.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.PriceList) {
                this.PriceList = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.priceList", this);
                this.getView().addDependent(this.PriceList);
                this.PriceList.setModel(this.getOwnerComponent().getModel());
            }

            if (!this.Currency) {
                this.Currency = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.Currency", this);
                this.getView().addDependent(this.Currency);
                this.Currency.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.Authorization) {
                this.Authorization = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.AuthorizationGrp", this);
                this.getView().addDependent(this.Authorization);
                this.Authorization.setModel(this.getOwnerComponent().getModel());
            }
            if (!this.salesDist) {
                this.salesDist = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.salesDistrict", this);
            ...
            if (!this.ShippingCondn) {
                this.ShippingCondn = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ShippingCondn", this);
            ...
            if (!this.blockReason) {
                this.blockReason = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.BlockedReason", this);
                this.getView().addDependent(this.blockReason);
                this.blockReason.setModel(this.getOwnerComponent().getModel());
            }

            if (!this.cs) {
                this.cs = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.creditSegmentData", this);
                this.getView().addDependent(this.creditSegment);
                this.cs.setModel(this.getOwnerComponent().getModel());
            }

            if (!this.furtherInfo) {
                this.furtherInfo = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.creditSegment", this);
                this.getView().addDependent(this.furtherInfo);
                this.furtherInfo.setModel(this.getOwnerComponent().getModel());
              }
              if (!this.infoCat) {
                this.infoCat = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.InfoCat", this);
                this.getView().addDependent(this.infoCat);
                this.infoCat.setModel(this.getOwnerComponent().getModel());
              }
              if (!this.indusType) {
                this.indusType = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.IndustryType", this);
        ...
        this.salesPanel = new sap.ui.xmlfragment("frag"+count, "customerReview.creditworthiness.fragments.salesPanel", this);
        ...
        handleGenerateSales:function () {
            ...
            var salesPanel = new sap.ui.xmlfragment("frag"+count, "customerReview.creditworthiness.fragments.salesPanel", this);

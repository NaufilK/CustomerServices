sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.CreditAnalysis.CreditAnalysisController", {
        /**
         * @override
         */
        onInit: function() {
            if (!this.CountryRating) {
                this.CountryRating = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.CountryRating", this);

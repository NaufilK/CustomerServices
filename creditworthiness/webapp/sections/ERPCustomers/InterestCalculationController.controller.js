sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.ERPCustomers.InterestCalculationController", {
        onInit: function() {
            // Controller.prototype.onInit.apply(this, arguments);
            if (!this.InterestIndicator) {
                this.InterestIndicator = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.InterestIndicator", this);

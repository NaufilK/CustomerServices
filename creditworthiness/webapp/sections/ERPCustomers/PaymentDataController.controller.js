sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.ERPCustomers.PaymentDataController", {
        /**
         * @override
         */
        onInit: function() {
            if (!this.paymentTerms) {
                this.paymentTerms = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.PaymentTerms", this);
                this.getView().addDependent(this.paymentTerms);
            }
            if (!this.KnwnNegtdLv) {
                this.KnwnNegtdLv = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.knowNegotiatedLv", this);
            ...
            if (!this.ARPledgeIndc) {
                this.ARPledgeIndc = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ARPledgingIndc", this);

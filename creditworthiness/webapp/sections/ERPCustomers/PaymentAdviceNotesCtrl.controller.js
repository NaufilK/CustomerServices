sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.ERPCustomers.PaymentAdviceNotesCtrl", {
        onInit: function() {
			if (!this.ReasonCodeConversion) {
                this.ReasonCodeConversion = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ReasonCodeConversion", this);
                this.getView().addDependent(this.ReasonCodeConversion);
            }
			if (!this.SelectionRule) {
                this.SelectionRule = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.SelectionRule", this);

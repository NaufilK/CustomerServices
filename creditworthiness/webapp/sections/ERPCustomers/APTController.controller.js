sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.ERPCustomers.APTController", {
        onInit: function() {
            ...
            if (!this.GroupingKey) {
                this.GroupingKey = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.GroupingKey", this);
                this.getView().addDependent(this.GroupingKey);
            }
            if (!this.SortKey) {
                this.SortKey = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.SortKey", this);
                this.getView().addDependent(this.SortKey);
            }
            if (!this.HouseBank) {
                this.HouseBank = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.HouseBank", this);
                this.getView().addDependent(this.HouseBank);
            }
            if (!this.PaymntMethdSuplmnt) {
                this.PaymntMethdSuplmnt = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.PaymntMethdSuplmnt", this);
                this.getView().addDependent(this.PaymntMethdSuplmnt);
                this.PaymntMethdSuplmnt.setModel(this.getOwnerComponent().getModel("S4D"));
            }
            if (!this.ReleaseGrp) {
                this.ReleaseGrp = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ReleaseGroup", this);
                this.getView().addDependent(this.ReleaseGrp);
            }
            if (!this.PlanningGrp) {
                this.PlanningGrp = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.PlanningGroup", this);
                this.getView().addDependent(this.PlanningGrp);
            }
            if (!this.ValueAdjustment) {
                this.ValueAdjustment = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.ValueAdjustment", this);
                this.getView().addDependent(this.ValueAdjustment);
            }
            if (!this.HeadOffice) {
                this.HeadOffice = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.HeadOffice", this);
                this.getView().addDependent(this.HeadOffice);
            }
            if (!this.CompCode) {
                this.CompCode = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.CompCode", this);

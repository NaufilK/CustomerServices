sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.ERPCustomers.CorrespondenceController", {
        onInit: function() {
                this.handleAccClerkModel();
                if (!this.AccountingClerk) {
                        this.AccountingClerk = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.AccoutingClerk", this);
                        this.getView().addDependent(this.AccountingClerk);
                }
                if (!this.AccountStatement) {
                        this.AccountStatement = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.AccountStatement", this);

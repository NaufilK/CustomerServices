sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.CustomerBasicDetails.InitiationDetailsController", {
        /**
         * @override
         */
        onInit: function () {
        ...
        onAfterRendering: function(oEvent){
            ...
            if (!this.businessUnit) {
                this.businessUnit = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.BusinessUnit", this);
                this.getView().addDependent(this.businessUnit);
            }
            if (!this.vertical) {
                this.vertical = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.Vertical", this);

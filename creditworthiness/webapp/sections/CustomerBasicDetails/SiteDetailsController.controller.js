sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("customerReview.creditworthiness.sections.CustomerBasicDetails.SiteDetailsController", {
            /**
             * @override
             */
            onInit: function() {
                ...
                if (!this.legalName) {
                    this.legalName = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.LegalName", this);

sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.CustomerBasicDetails.IdentificationNumbersController", {
		/**
		 * @override
		 */
		onInit: function() {
			...
			if (!this.License) {
				this.License = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.LicenceType",this);
				this.getView().addDependent(this.License);
				this.License.setModel(this.getOwnerComponent().getModel());
			  }
			if (!this.SrcOfEnquiry) {
				this.SrcOfEnquiry = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.SourceOfEnquiry",this);

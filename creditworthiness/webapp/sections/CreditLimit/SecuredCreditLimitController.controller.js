sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthiness.sections.CreditLimit.SecuredCreditLimitController", {
        onInit: function() {
            // Controller.prototype.onInit.apply(this, arguments);
            if (!this.bankCountry) {
                this.bankCountry = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.BankCountry", this);
                this.getView().addDependent(this.bankCountry);
            }
            if (!this.bank) {
                this.bank = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.Bank", this);
                this.getView().addDependent(this.bank);
            }

            if (!this.bankCountry1) {
                this.bankCountry1 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.BankCountryIc", this);
                this.getView().addDependent(this.bankCountry1);
            }
            if (!this.bank1) {
                this.bank1 = new sap.ui.xmlfragment("customerReview.creditworthiness.fragments.BankIc", this);

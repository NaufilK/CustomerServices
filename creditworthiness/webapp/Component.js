sap.ui.define(
  [
    ...
    "sap/ui/Device",
    "customerReview/creditworthiness/model/models",
  ...
  function (UIComponent, Device, models, JSONModel, MessageBox) {
    ...
    return UIComponent.extend("customerReview.creditworthiness.Component", {
      metadata: {
        manifest: "json",
      },
      ...
      setCustomerData: function (oContext) {
        ...
        oComponent.sPath =
          "/ZDD_CUSTOMER(zcustomer_num=guid'" + oComponent.zcustomer_num + "')";
        ...
        oModel.read(oComponent.sPath, {
          ...
          success: function (oData, oResponse) {
            ...
            var creditSegmentItem = oComponent
            ...
            for (var i = 0; i < oData.to_salesarea.results.length; i++) {
              salesItem.push({
                ...
                zdistribution_channel:
                  oData.to_salesarea.results[i].zdistribution_channel,
                zdistribution_channel_text:
                  oData.to_salesarea.results[i].zdistribution_channel_text,
                zdivision: oData.to_salesarea.results[i].zdivision,
                zdivision_text: oData.to_salesarea.results[i].zdivision_text,
                zsales_orgnization:
                  oData.to_salesarea.results[i].zsales_orgnization,
                zsales_orgnization_text:
                  oData.to_salesarea.results[i].zsales_orgnization_text,
                zsettlement_group:
                  oData.to_salesarea.results[i].zsettlement_group,
                zaccount_assignment_group:
                  oData.to_salesarea.results[i].zaccount_assignment_group,
                zagency_business:
                  oData.to_salesarea.results[i].zagency_business,
                zdocument_index_active:
                  oData.to_salesarea.results[i].zdocument_index_active,
                zmanual_invoice_maintenance:
                  oData.to_salesarea.results[i].zmanual_invoice_maintenance,
                zrebate: oData.to_salesarea.results[i].zrebate,
                zpricing: oData.to_salesarea.results[i].zpricing,
                zinvoicing_dates:
                  oData.to_salesarea.results[i].zinvoicing_dates,
                zinvoicing_list_dates:
                  oData.to_salesarea.results[i].zinvoicing_list_dates,
                zcustomer_group1:
                  oData.to_salesarea.results[i].zcustomer_group1,
                zcustomer_group2:
                  oData.to_salesarea.results[i].zcustomer_group2,
                zcustomer_group3:
                  oData.to_salesarea.results[i].zcustomer_group3,
                zcustomer_group4:
                  oData.to_salesarea.results[i].zcustomer_group4,
                zcustomer_group5:
                  oData.to_salesarea.results[i].zcustomer_group5,
                ...
                zcredit_control_area:
                  oData.to_salesarea.results[i].zcredit_control_area,
                zpayment_gurantee_procedure:
                  oData.to_salesarea.results[i].zpayment_gurantee_procedure,
                zcomplete_delivery:
                  oData.to_salesarea.results[i].zcomplete_delivery,
                zmaximum_number_of_part_delive:
                  oData.to_salesarea.results[i].zmaximum_number_of_part_delive,
                zpartial_delivery_per_item:
                  oData.to_salesarea.results[i].zpartial_delivery_per_item,
                zunlimited_tolerance:
                  oData.to_salesarea.results[i].zunlimited_tolerance,
                zunder_delivery_tolerance:
                  oData.to_salesarea.results[i].zunder_delivery_tolerance,
                zover_delivery_tolerance:
                  oData.to_salesarea.results[i].zover_delivery_tolerance,
                ...
                zprice_procedured_term:
                  oData.to_salesarea.results[i].zprice_procedured_term,
                zcustomer_statistics_group:
                  oData.to_salesarea.results[i].zcustomer_statistics_group,
                ...
                zaccount_at_customer:
                  oData.to_salesarea.results[i].zaccount_at_customer,
                zswitch_off_rounding:
                  oData.to_salesarea.results[i].zswitch_off_rounding,
                zorderprobability:
                  oData.to_salesarea.results[i].zorderprobability,
                zauthorization_group:
                  oData.to_salesarea.results[i].zauthorization_group,
                zitemproposal: oData.to_salesarea.results[i].zitemproposal,
                zunit_of_measure_group:
                  oData.to_salesarea.results[i].zunit_of_measure_group,
                zexchange_rate_type:
                  oData.to_salesarea.results[i].zexchange_rate_type,
                zpp_customer_procedure:
                  oData.to_salesarea.results[i].zpp_customer_procedure,
                zshipping_conditions:
                  oData.to_salesarea.results[i].zshipping_conditions,
                zdelivery_plant: oData.to_salesarea.results[i].zdelivery_plant,
                zdelivery_priority:
                  oData.to_salesarea.results[i].zdelivery_priority,
                zorder_combination:
                  oData.to_salesarea.results[i].zorder_combination,
                ...
                ztax_classification:
                  oData.to_salesarea.results[i].ztax_classification,
                ztax_category2: oData.to_salesarea.results[i].ztax_category2,
                ztax_classification2:
                  oData.to_salesarea.results[i].ztax_classification2,
                ...
                zrelationship_to_bp:
                  oData.to_salesarea.results[i].zrelationship_to_bp,
                zcredit_control_area_desc:
                  oData.to_salesarea.results[i].zcredit_control_area_desc,
                zcredit_segment_desc:
                  oData.to_salesarea.results[i].zcredit_segment_desc,
                zblockedincm: oData.to_salesarea.results[i].zblockedincm,
                zspecialattention:
                  oData.to_salesarea.results[i].zspecialattention,
                zutiliation_ptg: oData.to_salesarea.results[i].zutiliation_ptg,
                zresubmission_on:
                  oData.to_salesarea.results[i].zresubmission_on,
                ...
                zindividual_step:
                  oData.to_salesarea.results[i].zindividual_step,
                ...
                zresubmission_date:
                  oData.to_salesarea.results[i].zresubmission_date,
            ...
            for (var i = 0; i < oData.to_credit.results.length; i++) {
              creditSegmentItem.push({
                ...
                zresubmission_date:
                  oData.to_credit.results[i].zresubmission_date,
            ...
            oComponent
              ...
              .setProperty(
                "/vertical",
                oComponent.getModel("Customers").getData().zdescription
              );
            oComponent.handleEntityCheckModel(
              oComponent.getModel("Customers").getData().ztype_of_entity
            );
      ...
      handleEntityCheckModel: function (ztype_of_entity) {
        ...
        if (entityTypTitle && entityTypTitle == oModel.COOP) {
          ...
          entityTypTitle &&
          entityTypTitle == oModel.Ltd_Liability_partnrshp
        ) {
          appView.setProperty("/TypeOfEntity1", false);
          appView.setProperty("/TypeOfEntity2", false);
          appView.setProperty("/TypeOfEntity3", false);
          ...
          entityTypTitle &&
          entityTypTitle == oModel.Sole_Proprietorship
        ) {
          appView.setProperty("/TypeOfEntity1", false);
          appView.setProperty("/TypeOfEntity2", false);
          appView.setProperty("/TypeOfEntity3", false);
      ...
      getDmsData: function (evt) {
        ...
        var path =
          "/GetAllOriginals?LinkedSAPObjectKey='" +
          oComponent.zcustomer_num +
        ...
        oModel.read(path, {
          success: function (oData, oResponse) {
            var attachmentsItem = oComponent
            ...
            for (var i = 0; i < oData.results.length; i++) {
              attachmentsItem.push({
                ...
                DocumentInfoRecordDocType:
                  oData.results[i].DocumentInfoRecordDocType,
                DocumentInfoRecordDocNumber:
                  oData.results[i].DocumentInfoRecordDocNumber,
                ...
                DocumentInfoRecordDocVersion:
                  oData.results[i].DocumentInfoRecordDocVersion,
                DocumentInfoRecordDocPart:
                  oData.results[i].DocumentInfoRecordDocPart,
                Flag: "U",
              });
            }
      ...
      handleRuleEngineConfiguration: function (oEvent) {
        ...
        oModel.read("/Zdd_rule_engine", {
          ...
          success: function (oData, oResponse) {
            for (var i = 0; i < oData.results.length; i++) {
              if (
                oData.results[i].process === oComponent.process &&
      ...
      updateFeilds: function (evt) {
        ...
        oModel.read("/ZDD_RULE_UPDATE", {
          ...
          error: function (err) {}.bind(oComponent),
        });
      },
      ...
      handleGenerateSales: function () {
        if (
          oComponent.getModel("appView").getProperty("/generateSale") === false
        ) {
          if (oComponent.getModel("salesDataModel").getData().length > 0) {
            for (
              var i = 0;
              i < oComponent.getModel("salesDataModel").getData().length;
              i++
            ) {
              var count = i;
              ...
              var salesPanel = new sap.ui.xmlfragment(
                "frag" + count,
                "customerReview.creditworthiness.fragments.salesPanel",
                this
              );
              oComponent.addDependent(salesPanel);
              container.addItem(salesPanel);
              var salesOrg = oComponent.getModel("salesDataModel").getData()[
                i
              ].zsales_orgnization;
              var distribution = oComponent
                .getModel("salesDataModel")
                .getData()[i].zdistribution_channel;
              var division = oComponent.getModel("salesDataModel").getData()[
                i
              ].zdivision;

    ...
    function (Controller) {
        ...
        return Controller.extend("customerReview.customerServiceUI.sections.CustomerBasicDetails.ProfileDetailsController", {
            ...
            onInit: function() {
                ...
                if (!this.Region) {
                    this.Region = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.State", this);
                    this.getView().addDependent(this.Region);
                    //this.Region.setModel(this.getOwnerComponent().getModel("S4D"));
                }
                if (!this.TransprtZone) {
                    this.TransprtZone = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.TrsptnZone", this);
                    this.getView().addDependent(this.TransprtZone);
                    this.TransprtZone.setModel(this.getOwnerComponent().getModel("S4D"));
                }
                if (!this.Language) {
                    this.Language = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.Language", this);
                    this.getView().addDependent(this.Language);
                    this.Language.setModel(this.getOwnerComponent().getModel("S4D"));
                }
                if (!this.entityType) {
                    this.entityType = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.TypeOfEntity", this);

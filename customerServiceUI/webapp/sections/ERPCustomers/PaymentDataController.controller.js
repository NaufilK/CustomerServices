sap.ui.define([
	...
	return Controller.extend("customerReview.customerServiceUI.sections.ERPCustomers.PaymentDataController", {
        ...
        onInit: function() {
            ...
            if (!this.KnwnNegtdLv) {
                this.KnwnNegtdLv = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.knowNegotiatedLv", this);
            ...
            if (!this.ARPledgeIndc) {
                this.ARPledgeIndc = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.ARPledgingIndc", this);

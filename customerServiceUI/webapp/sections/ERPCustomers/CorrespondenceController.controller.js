sap.ui.define([
	...
	return Controller.extend("customerReview.customerServiceUI.sections.ERPCustomers.CorrespondenceController", {
        onInit: function() {
                this.handleAccClerkModel();
                if (!this.AccountingClerk) {
                        this.AccountingClerk = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.AccoutingClerk", this);
                        this.getView().addDependent(this.AccountingClerk);
                }
                if (!this.AccountStatement) {
                        this.AccountStatement = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.AccountStatement", this);

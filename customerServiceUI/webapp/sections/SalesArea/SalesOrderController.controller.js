        ...
        return Controller.extend("customerReview.customerServiceUI.sections.SalesArea.SalesOrderController", {
            ...
            onInit: function() {
                ...
                if (!this.unitOfMsrGrp) {
                    this.unitOfMsrGrp = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.UnitOfMeasureGrp", this);
                ...
                if (!this.exchngRateType) {
                    this.exchngRateType = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.ExchangeRateType", this);
                ...
                if (!this.PPCustProcedure) {
                    this.PPCustProcedure = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.PPCustrProcedure", this);

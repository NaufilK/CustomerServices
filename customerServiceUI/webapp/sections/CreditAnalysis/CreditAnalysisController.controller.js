sap.ui.define([
	...
	return Controller.extend("customerReview.customerServiceUI.sections.CreditAnalysis.CreditAnalysisController", {
        /**
         * @override
         */
        onInit: function() {
            if (!this.CountryRating) {
                this.CountryRating = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.CountryRating", this);

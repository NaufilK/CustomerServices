sap.ui.define([
	...
	return Controller.extend("customerReview.customerServiceUI.sections.ERPCustomers.InterestCalculationController", {
        onInit: function() {
            // Controller.prototype.onInit.apply(this, arguments);
            if (!this.InterestIndicator) {
                this.InterestIndicator = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.InterestIndicator", this);

sap.ui.define([
	...
	return Controller.extend("customerReview.customerServiceUI.sections.ERPCustomers.PaymentAdviceNotesCtrl", {
        onInit: function() {
			if (!this.ReasonCodeConversion) {
                this.ReasonCodeConversion = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.ReasonCodeConversion", this);
                this.getView().addDependent(this.ReasonCodeConversion);
            }
			if (!this.SelectionRule) {
                this.SelectionRule = new sap.ui.xmlfragment("customerReview.customerServiceUI.fragments.SelectionRule", this);

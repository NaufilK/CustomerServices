sap.ui.define([
    ...
    function (Controller, MessageBox) {
        ...
        return Controller.extend("customerReview.creditworthinessui.sections.CustomerBackground.DetailsOfExpectedBusinessController", {
            /**
             * @override
             */
            onInit: function() {
                ...
                if (!this.Incoterms) {
                    this.Incoterms = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.Incoterms", this);
                    this.getView().addDependent(this.Incoterms);
                    this.Incoterms.setModel(this.getOwnerComponent().getModel());
                }
                if (!this.Currency) {
                    this.Currency = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.Currency", this);

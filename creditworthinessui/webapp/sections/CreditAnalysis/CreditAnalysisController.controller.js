sap.ui.define([
	...
	return Controller.extend("customerReview.creditworthinessui.sections.CreditAnalysis.CreditAnalysisController", {
        /**
         * @override
         */
        onInit: function() {
            if (!this.CountryRating) {
                this.CountryRating = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.CountryRating", this);

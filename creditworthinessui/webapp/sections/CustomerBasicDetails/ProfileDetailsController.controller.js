sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("customerReview.creditworthinessui.sections.CustomerBasicDetails.ProfileDetailsController", {
            /**
             * @override
             */
            onInit: function () {
                ...
                if (!this.Country) {
                    this.Country = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.Country", this);
                    this.getView().addDependent(this.Country);
                }
                if (!this.Region) {
                    this.Region = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.State", this);
                    this.getView().addDependent(this.Region);
                    //this.Region.setModel(this.getOwnerComponent().getModel("S4D"));
                }
                if (!this.TransprtZone) {
                    this.TransprtZone = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.TrsptnZone", this);
                    this.getView().addDependent(this.TransprtZone);
                    // this.TransprtZone.setModel(this.getOwnerComponent().getModel("S4D"));
                }
                if (!this.Language) {
                    this.Language = new sap.ui.xmlfragment("customerReview.creditworthinessui.fragments.Language", this);

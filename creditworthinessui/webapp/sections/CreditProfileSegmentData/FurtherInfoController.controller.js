sap.ui.define(
  ...
  function (Controller, formatter, MessageBox) {
    ...
    return Controller.extend(
      "customerReview.customerServiceUI.sections.CreditProfileSegmentData.FurtherInfoController",
      {
        formatter: formatter,
        /**
         * @override
        ...
        onInit: function () {
          if (!this.furtherInfo) {
            this.furtherInfo = new sap.ui.xmlfragment(
              "customerReview.customerServiceUI.fragments.creditSegment",
              this
            );
          ...
          if (!this.infoCat) {
            this.infoCat = new sap.ui.xmlfragment(
              "customerReview.customerServiceUI.fragments.InfoCat",
              this
            );
          ...
          if (!this.indusType) {
            this.indusType = new sap.ui.xmlfragment(
              "customerReview.customerServiceUI.fragments.IndustryType",
              this
            );

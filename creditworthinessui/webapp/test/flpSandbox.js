		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Credit Worthiness Approval",
									"targetURL": "#customerReviewcreditworthinessui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerReviewcreditworthinessui-display": {
								"semanticObject": "customerReviewcreditworthinessui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerReview.creditworthinessui",
									"url": sap.ui.require.toUrl("customerReview/creditworthinessui")
								}
							}
						}
					}

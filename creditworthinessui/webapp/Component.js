sap.ui.define(
    [
      ...
      "sap/ui/Device",
      "customerReview/creditworthinessui/model/models",
    ...
    function (UIComponent, Device, models, JSONModel, MessageBox) {
      ...
      return UIComponent.extend(
        "customerReview.creditworthinessui.Component",
        {
          metadata: {
            manifest: "json",
          },
          ...
          handleGenerateSales:function () {
            ...
            if(oComponent.getModel("salesDataModel").getData().length > 0){
                ...
                var salesPanel = new sap.ui.xmlfragment("frag"+count, "customerReview.creditworthinessui.fragments.salesPanel", this);
